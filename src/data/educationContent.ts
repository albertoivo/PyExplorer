...
export const WORLD_TUTORIALS: WorldTutorial[] = [
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 8,
        keyConcepts: ['variáveis', 'atribuição', 'tipos', 'int', 'str', 'float', 'conversão'],
        steps: [
            {
                icon: '📦',
            ...
            },
            {
                ...
                content: 'Python tem 4 tipos básicos de dados: int (números inteiros), str (textos), float (números decimais) e bool (verdadeiro/falso).',
                code: 'numero = 42        # int\nnome = "Ana"       # str\naltura = 1.65      # float\nativo = True       # bool',
                animation: 'slideUp',
            },
            {
                ...
                content: 'Use type() para descobrir o tipo de qualquer variável. É como perguntar: "Que tipo de coisa você é?"',
            ...
            },
            {
                ...
                content: 'Às vezes você precisa converter um tipo em outro. Use int(), str() e float() para isso!',
                code: 'texto = "42"\nnumero = int(texto)  # texto vira número\nprint(numero + 8)',
                output: '50',
                animation: 'bounce',
            },
            {
                ...
                content: 'Use + para juntar textos! Mas atenção: para juntar texto com número, primeiro converta com str().',
                code: 'idade = 10\nmensagem = "Tenho " + str(idade) + " anos"\nprint(mensagem)',
                output: 'Tenho 10 anos',
                animation: 'bounce',
            },
            {
                icon: '📏',
            ...
            },
            {
                ...
                content: 'Agora você sabe guardar informações, os 4 tipos básicos e como converter entre eles! Isso é super importante!',
                animation: 'bounce',
            },
        ],
    },
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 10,
        keyConcepts: ['if', 'else', 'elif', 'comparações', 'and', 'or', 'not', 'in'],
        steps: [
            {
                icon: '🤔',
            ...
            {
                icon: '🤝',
                title: 'E: Duas Condições Juntas',
                content: 'Use and ("e") quando DUAS condições precisam ser verdadeiras. As duas precisam ser verdade!',
            ...
            {
                icon: '🔀',
                title: 'OU: Uma ou Outra',
                content: 'Use or ("ou") quando PELO MENOS UMA condição precisa ser verdadeira. Basta uma!',
            ...
            {
                icon: '🚫',
                title: 'NÃO: Invertendo',
                content: 'Use not ("não") para inverter uma condição. True vira False e False vira True!',
                code: 'chovendo = False\n\nif not chovendo:\n    print("Vou passear!")',
                output: 'Vou passear!',
                animation: 'bounce',
            },
            {
                icon: '📋',
                title: 'DENTRO: Verificando com in',
                content: 'Use in para verificar se algo está dentro de uma lista ou texto. Super útil!',
            ...
            },
            {
                ...
                content: 'Agora você domina if, else, elif, and, or, not e in! Seus programas podem tomar decisões complexas!',
                animation: 'bounce',
            },
        ],
    },
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 9,
        keyConcepts: ['for', 'range()', 'while', 'break', 'continue'],
        steps: [
            {
                icon: '♾️',
            ...
            {
                icon: '🛑',
                title: 'break: Freio de Emergência!',
                content: 'Use break para PARAR o loop imediatamente! É como apertar o freio de emergência.',
            ...
            {
                icon: '⏭️',
                title: 'continue: Pular uma Volta',
                content: 'Use continue para PULAR para a próxima volta do loop, sem executar o resto do código.',
            ...
            },
            {
                ...
                content: 'Você aprendeu for, while, break e continue! Agora pode controlar loops como um profissional!',
                animation: 'bounce',
            },
        ],
    },
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 9,
        keyConcepts: ['lista', 'índice', 'append', 'len', 'slicing', 'pop', 'sort'],
        steps: [
            {
                icon: '📋',
            ...
            {
                icon: '✂️',
                title: 'Fatiando a Lista (Slicing)',
                content: 'Use [início:fim] para pegar um pedaço da lista. O fim não entra! É como cortar um bolo.',
                code: 'numeros = [10, 20, 30, 40, 50]\nprint(numeros[1:3])  # do índice 1 até antes do 3\nprint(numeros[:2])   # do início até antes do 2',
                output: '[20, 30]\n[10, 20]',
                animation: 'typewriter',
            },
            {
            ...
            },
            {
                ...
                content: 'Use .pop() para remover o último, ou .remove() para remover pelo valor.',
            ...
            },
            {
                ...
                content: 'Use .sort() para colocar os itens em ordem!',
                code: 'numeros = [3, 1, 4, 1, 5]\nnumeros.sort()\nprint(numeros)',
                output: '[1, 1, 3, 4, 5]',
                animation: 'bounce',
            },
            {
            ...
            },
            {
                ...
                content: 'Você domina listas! Criar, acessar, fatiar, adicionar, remover e ordenar. Listas são essenciais em programação!',
                animation: 'bounce',
            },
        ],
    },
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 10,
        keyConcepts: ['def', 'parâmetros', 'return', 'padrão', 'escopo'],
        steps: [
            {
                icon: '📖',
            ...
            },
            {
                ...
                content: 'Você pode dar um valor padrão para um parâmetro! Se ninguém passar, usa o padrão. É como um plano B.',
                code: 'def saudar(nome="Amigo"):\n    print("Olá, " + nome + "!")\n\nsaudar()        # usa "Amigo"\nsaudar("Ana")   # usa "Ana"',
                output: 'Olá, Amigo!\nOlá, Ana!',
                animation: 'typewriter',
            },
            {
                icon: '🔒',
                title: 'Escopo: Variáveis Locais',
                content: 'Variáveis criadas DENTRO de uma função só existem lá! Elas "morrem" quando a função termina. São chamadas variáveis locais.',
                code: 'def funcao():\n    segredo = 42  # só existe aqui!\n    print(segredo)\n\nfuncao()\n# print(segredo)  # ERRO! Não existe fora',
                output: '42',
                animation: 'slideUp',
            },
            {
                ...
                content: 'Você domina funções! Criar, parâmetros, return, valores padrão e escopo. Suas funções vão deixar seu código incrível!',
                animation: 'bounce',
            },
        ],
    },
    ...
    // ============================================
    {
        ...
        estimatedMinutes: 9,
        keyConcepts: ['string', 'métodos', 'f-string', 'split', 'join', 'fatiamento'],
        steps: [
            {
                icon: '💬',
            ...
            },
            {
                ...
                content: 'Strings têm superpoderes! Use .upper() para maiúsculas, .lower() para minúsculas.',
                code: 'texto = "Python"\nprint(texto.upper())\nprint(texto.lower())',
                output: 'PYTHON\npython',
                animation: 'bounce',
            },
            {
                icon: '✂️',
                title: 'Quebrando Texto: split()',
                content: 'split() divide o texto em uma lista! Por padrão corta nos espaços, mas você pode escolher o separador.',
                code: 'frase = "Eu amo Python"\npalavras = frase.split()\nprint(palavras)',
                output: "['Eu', 'amo', 'Python']",
                animation: 'typewriter',
            },
            {
                icon: '🧲',
                title: 'Juntando Lista: join()',
                content: 'join() é o oposto de split! Junta uma lista de palavras em um texto único.',
                code: 'palavras = ["Eu", "amo", "Python"]\nfrase = " ".join(palavras)\nprint(frase)',
                output: 'Eu amo Python',
                animation: 'slideUp',
            },
            {
            ...
            },
            {
                ...
                content: 'Você domina textos! Juntar, separar, fatiar, transformar... Strings são essenciais em todo programa!',
                animation: 'bounce',
            },
        ],
    },
